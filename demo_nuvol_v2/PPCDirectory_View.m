...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row % 2 == 0){
        ...
        [PPCCommon_Methods setTextView:cell.nameCard2 andDict:auxDict andKey:@"nombre" andTextColor:@"#9AB4CB" andIsBold:false];
        [PPCCommon_Methods setTextView:cell.jobPosition2 andDict:auxDict andKey:@"puesto" andTextColor:@"#000000" andIsBold:true];
